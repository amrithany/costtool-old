...
urlpatterns = patterns('',
    ...
    url(r'^project/programs/costs/(?P<price_id>\d+)/decideCat.html$', 'costtool.views.decideCat', name='decideCat'),
    ...
    url(r'^project/programs/costs/(?P<ing_id>\d+)/del_ingredient.html$', 'costtool.views.del_ingredient', name='del_ingredient'),
    url(r'^project/programs/costs/(?P<ing_id>\d+)/dupl_ingredient.html$', 'costtool.views.dupl_ingredient', name='dupl_ingredient'),
